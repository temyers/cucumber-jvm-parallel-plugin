...
@RunWith(Parameterized.class) public class ClassNamingSchemeFactoryTest {

    @Parameter(0) public String namingScheme;
    @Parameter(1) public String pattern;
    @Parameter(2) public String expectedResult;
    @Parameter(3) public Integer nextCount;
    ...
    @Parameters public static Collection<Object[]> params() {
        final Object[][] params =
            {{"simple", "", "Parallel01IT", 1}, {"simple", "", "Parallel02IT", 2},
                {"feature-title", "", "Feature101IT", 1}, {"feature-title", "", "Feature102IT", 2},
    ...
    @Test public void createWithValidParams() throws Exception {
