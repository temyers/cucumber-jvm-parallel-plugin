...
public class TagFilterTest {
    ...
    public void shouldExcludeScenariosWhenFilteringByNotTags() throws Exception {
        ...
        ScenarioAndSourceLocation firstMatch = matchingScenariosAndExamples.iterator().next();
        assertThat(((ScenarioDefinition) firstMatch.getScenarioDefinition()).getName())
    ...
    public void shouldIncludeExamplesWhenFilteringByTagsAtExampleLevel() throws Exception {
        ...
        ScenarioAndSourceLocation firstMatch = matchingScenariosAndExamples.iterator().next();
        assertThat(firstMatch.getSource().getLocation().getLine()).isEqualTo(12);
    }
