 ...
 * Adapted from Cucumbers RuntimeOptionsTest
 */
public class RuntimeOptionsTest {
    ...
    public void parses_plugin() {
        final RuntimeOptions options = new RuntimeOptions(asList("--plugin", "html:some/dir", "--glue", "somewhere"));
        assertEquals("html:some/dir", options.getPluginNames().get(0));
    }

    @Test
    public void parses_multiple_plugins() {
        final RuntimeOptions options = new RuntimeOptions(asList("--plugin", "html:some/dir", "--plugin", "pretty", "--glue", "somewhere"));
    ...
    public void assigns_strict() {
        final RuntimeOptions options = new RuntimeOptions(asList("--strict", "--glue", "somewhere"));
    ...
    public void shouldParseTagsWhenMultipleWhitespaceBetweenOptionArgs() {
        final RuntimeOptions parser = new RuntimeOptions(CUCUMBER_OPTS_WITH_MULTI_WHITESPACE_BETWEEN_ARGS);
