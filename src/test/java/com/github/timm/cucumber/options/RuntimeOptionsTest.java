...
public class RuntimeOptionsTest {
    ...
    @Test public void assigns_filters_from_tags() {
    ...
    @Test public void strips_options() {
    ...
    @Test public void parses_multiple_plugins() {
