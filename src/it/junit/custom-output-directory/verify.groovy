...
@CucumberOptions(strict = true, features = {"${feature1.absolutePath}"}, tags = {"@complete", "@accepted"}, plugin = {"json:target/my-custom-dir/1.json"},
...
@RunWith(Cucumber.class)
@CucumberOptions(strict = true, features = {"${feature2.absolutePath}"}, tags = {"@complete", "@accepted"}, plugin = {"json:target/my-custom-dir/2.json"},
monochrome = false, glue = { "foo", "bar" })
