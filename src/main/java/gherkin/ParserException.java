...
public class ParserException extends RuntimeException {
    ...
    public static class UnexpectedTokenException extends ParserException {
        ...
        public UnexpectedTokenException(Token receivedToken,
                                        List<String> expectedTokenTypes, String stateComment) {
    ...
    public static class CompositeParserException extends ParserException {
        ...
        private static String getMessage(List<ParserException> errors) {
            ...
            StringUtils.ToString<ParserException> exceptionToString
                = new StringUtils.ToString<ParserException>() {
                    @Override
